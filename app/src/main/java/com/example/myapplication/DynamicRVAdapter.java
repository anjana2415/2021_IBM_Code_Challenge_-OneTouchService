...
public class DynamicRVAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public DynamicRVAdapter(RecyclerView recyclerView,Activity activity, List<DynamicRecyclerViewModel> items) {
    ...
    public  void setLoadMore(LoadMode loadMore){
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        if(viewType == VIEW_TYPE_ITEM){
            ...
            View view = LayoutInflater.from(activity).inflate(R.layout.dynamic_progressbar,parent,false);
            return new LoadingViewHolder(view);
        }
        return null;
    }
